function result = batchFibermetricTest(inDir, outDir)
%batchFibermetricTest Batch process images using myimfcn
...
if(nargin<1)
    inDir = 'E:\Users\plummt\Documents\MATLAB\Plant-Imaging-Platform\images';
end
...
workSpaceFields = {
    'bwBright','bwDark','grid','imgray','input'
    };
...
parfor imgInd = 1:numel(imds.Files)
    ...
    inImageFile  = imds.Files{imgInd}; %#ok<PFBNS>
